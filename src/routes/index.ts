...
router.post('/api/clipping/findAllAndCount', clippingController.findAllAndCount);
router.post('/api/clipping/findAllFavorite', clippingController.findAllFavorite);
router.post('/api/clipping/findAllClippingsByBook', clippingController.findAllClippingsByBook);
router.post('/api/clipping/findAllBook', clippingController.findAllBook);

// 文件模块
router.post('/api/file/add', KoaBody({
    multipart: true,
    formidable: {
        uploadDir: path.join(__dirname, '../../assets/uploads/'),
    },
